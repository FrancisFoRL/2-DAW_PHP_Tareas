        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            <div class="mx-auto w-1/2 bg-gray-200 rounded shadow-lg px-2 py-4">
                <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <x-jet-input type="text" name="nombre" class="w-full mb-3" value="{{ old('nombre') }}" />
                    ...
                    <x-jet-input type="number" name="stock" class="w-full mb-3" value="{{ old('stock') }}" />
                    ...
                    <div class="mx-auto mt-5">
                        <img src="{{ Storage::url('noimage.png') }}" class="mx-auto rounded object-cover object-center" width="300px"
                            height="300px" id="img">
