...
if ((isset($_POST['btn']))) {
    ...
    if ($_FILES['portada']['error'] == 0) {
        //! Continuear con validacion imagenes
    ...
    $_SESSION['mensaje'] = "El libro se creo correctamente";
...
?>
    ...
    <body style="background-color: #F0544F;">
        <h5 class="text-center mt-4 bolder fw-bold">Nuevo Libro</h5>
        <div class="container">
            <form name="a" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data" class="py-4 px-4 mx-auto text-light bg-dark rounded" style="width: 50rem;">
                <div class="row mt-4">
                    <div class="col">
                ...
                <div class="row mt-4">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="col">
                            <textarea class="form-control" placeholder="Descripción" id="floatingTextarea2" name="descripcion" style="height: 100px" maxlength="400"></textarea>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="mt-4 text-center">
                        <img class="img-thumbnail" src="../img/libros/default.png" id="image" style="width: 10rem; height: 10rem;">
                    </div>
                    <div class="mt-4">
